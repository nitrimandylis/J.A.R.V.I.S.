---
name: end
description: Session wrap-up for Nick's JARVIS assistant. Use when ending a session, or when Nick says "wrap up", "end session", "log today", or wants to save a daily note summarizing the session.
---
